...
while True:
    ...
    if vida == 0:
        print('🔴​ Game over 🔴​')
        sys.exit() #Este bucle termina cuando llega a 0 vidas cuando vida = 0, y vuelta a empezar si el usuario decide comenzar una partida nueva
